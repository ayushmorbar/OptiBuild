...
| **4. Agent skills (Agents CLI)** | **Code or Video** | **Evaluation & Quality Suite**: Full implementation of the `basic-dataset.json` containing 23 test cases and `eval_config.yaml` to run, grade, and optimize model performance using the `agents-cli eval` suite. |
